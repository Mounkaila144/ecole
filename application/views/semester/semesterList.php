            ...
            if ($this->rbac->hasPrivilege('semester', 'can_add')) {
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url('evaluation/semester/index') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="mailbox-date pull-right ">
                                            ...
                                            if ($this->rbac->hasPrivilege('evaluation', 'can_view')) {
                                                ?>
                                                <a href="<?php echo base_url(); ?>evaluation/evaluation/index/<?php echo $semester['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('evaluations'); ?>">
                                            ...
                                            if ($this->rbac->hasPrivilege('semester', 'can_delete')) {
                                                ?>
                                                <a href="<?php echo base_url(); ?>evaluation/semester/delete/<?php echo $semester['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line("semester_will_also_delete_all_evalutions_under_this_semester_so_be_careful_as_this_action_is_irreversible"); ?>');">
